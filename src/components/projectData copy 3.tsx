...
const projectData: Project[] = [
  // 닥포
  {
    ...
    modalContent: {
      ...
      contribution:"기여도 : 50%",
      description:
        "고객이 두피 상담 폼을 통해 문의를 남기면, 관리자(상담사)가 백오피스에서 해당 내용을 확인하고 답변을 등록할 수 있는 양방향 상담 기능을 기획 및 개발하였습니다.",
      link: "https://drforhair2024.cafe24.com/skin-skin2",
      github: "",
      features: [
        "SCSS를 사용하여 스타일을 적용",
  ...
  // AAT
  {
    ...
    gifImage: "/img/aat_01_g.gif",
    technologies: ["SI", "React", "TypeScript", "Redux", "Aixos", "반응형"],
  ...
  // 팻케어랩
  {
    ...
    technologies: ["SI", "React", "다국어", "반응형"],
    contribution: ["퍼블리싱"],
    modalContent: {
      title: "PetCare Lab",
      date: "작업기간 : 2023.6. ~ 2023.6. (2주)",
      team: "팀 구성 : 퍼블리셔 및 디자인 1명, 기획자 1명",
      contribution:"기여도 : 디자인 및 퍼블리싱을 담당하였습니다.",
      description:
        "펫케어랩 홈페이지 디자인 및 퍼블리싱을 담당하였습니다.",
      link: "https://petcarelab.net/",
      github: "",
      features: [
