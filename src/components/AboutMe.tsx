          ...
          >
            ...
            <div className="flex-[1.8_1.8_0%] max-xl:flex-1">
              <p className="text-lg px-20 max-xl:py-12 max-xl:text-base max-md:px-7 max-md:py-10">
                ...
                2018년부터 웹디자인과 퍼블리싱을 병행하며 자사몰부터 에이전시까지 다양한 쇼핑몰 운영 경험을 쌓아왔습니다. 탑스타에서는 카페24 기반 자사몰의 디자인을 담당하며,<br />
                <b>기존의 딱딱하고 무거운 명품 이미지를 벗어나 키치하고 영한 무드로 리뉴얼을 기획·진행했고, 그 결과 20~30대 신규 가입자 수를 10% 이상 증가시키는 성과를 냈습니다.
                <br />
                또한, 2,000건 이상의 상품 촬영과 이미지 보정, 상세페이지 제작을 직접 수행하며 전반적인 비주얼 콘텐츠 제작 경험을 쌓았습니다.</b>
                <br /><br />

                이후 에이아이댑스에서는 플랫폼 웹사이트를 직접 개발하여 <b>5건의 신규 웹사이트를 구축하였고, 10건 이상의 웹사이트를 유지보수하며 웹디자인뿐 아니라 퍼블리싱과 프론트엔드 개발까지 전체 프로세스를 이해하고 경험</b>할 수 있었습니다.<br /><br />

                가장 최근에는 웹 에이전시 <b>리더마인에서 농심몰, 아모레퍼시픽몰, 하이트진로 등 대형 브랜드 쇼핑몰의 유지보수를 맡아 카페24 기반의 사이트 구축, 기획전·이벤트 페이지 퍼블리싱, 관리자 페이지 UI 작업 등을 수행</b>했습니다.<br />
                이러한 전반적인 경험을 통해 <b>자사몰과 클라이언트몰 모두를 운영해 본 실무 중심의 웹디자이너/퍼블리셔로 성장</b>할 수 있었습니다.<br /><br />

                <b>저는 혼자보다는 팀과 함께일 때 더 큰 임팩트를 만들 수 있다고 믿으며</b>, 다양한 직무의 구성원들과 능동적으로 커뮤니케이션하고 협업하는 일에 큰 가치를 두고 있습니다.
